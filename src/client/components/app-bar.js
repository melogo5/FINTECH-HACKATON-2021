...
export default class AppBar extends Component {
  ...
  <template>
    <style>${style}</style>
    <a id="bar1" class="menuItem" href="#main/profile">
    ...
    <a id="bar2" class="menuItem" href="#main/vacancy">
      <svg class="a__icon" viewBox="0 0 24 24">
        <path
    ...
    <a id="bar3" class="menuItem" href="#main/candidates">
      <svg class="a__icon" viewBox="0 0 24 24">
        <path
    ...
    <a id="bar4" class="menuItem" href="#main/notification">
      <svg class="a__icon" viewBox="0 0 24 24">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
