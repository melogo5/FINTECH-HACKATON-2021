    ...
    static template = html`
      <template>
        ...
        <div>
            <a href="#" target="_blank">
                <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 12C0 5.373 5.373 0 12 0s12 5.373 12 12-5.373 12-12 12S0 18.627 0 12z" fill="#0077B5"></path>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.66 7.411c0 .785-.591 1.413-1.54 1.413h-.017C6.19 8.824 5.6 8.196 5.6 7.41 5.6 6.611 6.208 6 7.139 6c.93 0 1.503.61 1.52 1.411zM8.48 9.94v8.17H5.76V9.94h2.72zm9.808 8.17v-4.684c0-2.51-1.342-3.678-3.131-3.678-1.444 0-2.09.793-2.452 1.35V9.939h-2.72c.036.767 0 8.171 0 8.171h2.72v-4.563c0-.245.018-.488.09-.663.196-.488.644-.993 1.395-.993.985 0 1.378.75 1.378 1.847v4.372h2.72z" fill="#F6F6F6"></path>
                </svg>
            </a>
        </div>
        <div>
